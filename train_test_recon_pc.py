...
def get_dataset(split, args):
    from datasets.solidmnist import SolidMNISTWithPointclouds, SolidMNISTPointclouds
    from datasets.abcdataset import ABCDatasetWithPointclouds, ABCDatasetPointclouds
