...
if __name__ == '__main__':
    ...
    dfs = {
        'Gram': pd.read_csv('all_raw_grams_layer_probe_scores_with_err.csv'),
        'INorm': pd.read_csv('all_inorm_only_layer_probe_scores_with_err.csv'),
        'FNorm Only': pd.read_csv('all_fnorm_only_layer_probe_scores_with_err.csv'),
        'Face\nRe-centering': pd.read_csv('all_layer_probe_scores_with_err.csv'),
    }
    ...
    fig.tight_layout()
    fig.savefig('normalization_comparison.pdf')
    fig.show()
