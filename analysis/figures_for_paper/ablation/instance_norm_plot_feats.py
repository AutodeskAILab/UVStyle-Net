...
if __name__ == '__main__':
    ...
    dfs = {
        ...
        'Sigma': pd.read_csv('uvnet_solidmnist_subset_feats_sigma_layer_probe_scores_with_err.csv'),
        'Sigma + INorm': pd.read_csv('uvnet_solidmnist_subset_feats_sigma_inorm_layer_probe_scores_with_err.csv'),
